        ...
        <form class="form" onsubmit="return false">
          <div>
            <p class="headerForm">
              ...
              3. Отправьте претензию подрядчику по почте.
            </p>
          </div>
          ...
          <div class="input-container">
            <label
                class="labelForm" for="nameBuilder">Наименование подрядной организации</label>
            <input
                class="inputForm"
                type="text"
                id="nameBuilder"
            ...
            <p class="hintInputContainer">
              Обратите внимание, требуется указать <b>правильное, полное</b> название подрядной организации, на которую вы хотите направить претензию.
            </p>
          </div>

          <div class="input-container">
            <label class="labelForm" for="addressBuilder">Юридический адрес подрядной организации</label>
            <input
                class="inputForm"
                type="text"
                id="addressBuilder"
            ...
            />
            <p class="hintInputContainer">
              Верный юр. адрес можно найти на яндексе (<a href="https://ya.ru/" target="_blank">ya.ru</a>), <br>введя в поисковую строку полное название подрядной организации.</p>
          </div>

          <h3>От кого:</h3>

          <div class="input-container">
            <label class="labelForm" for="nameClaimant">Укажите от кого подается претензия</label>
            <input
                class="inputForm"
                type="text"
                id="nameClaimant"
            ...
            />
            <p class="hintInputContainer">
              Укажите должность, ФИО, наименование организации.
            </p>
          </div>
          ...
          <div class="input-container">
            ...
            />
            <p class="hintInputContainer">
              Укажите почтовый адрес, куда получатель сможет отправить вам ответ на эту претензию.
            </p>
          </div>
          ...
          <div class="input-container">
            ...
            />
            <p class="hintInputContainer">
              Укажите контактный номер телефона по которому получатель претензии сможет с вами связаться.
            </p>
          </div>
          ...
          <div class="input-container" v-if="roomType === 'Квартира №' || roomType === 'Квартира с ремонтом №'">
          ...
          <div class="input-container">
            ...
            <p class="hintInputContainer">
              Если данный дефект уже выявлялся ранее и выявлен снова - выбирайте "повторно".
            </p>
          </div>
    ...
    data() {
      return {
        ...
        optionsRoomType: [
          ...
          {text:'Квартира с ремонтом', value: 'Квартира с ремонтом №'},
